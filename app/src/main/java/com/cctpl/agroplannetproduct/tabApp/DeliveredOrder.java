...
import com.cctpl.agroplannetproduct.Adapter.delivered_order_adapter;
...
public class DeliveredOrder extends Fragment {
    RecyclerView Pending_order ;
    delivered_order_adapter Adapter ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_delivered_order, container, false);
        ...
        db.collection("Pending Order").whereEqualTo("Flag","2").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
                ...
                for (DocumentChange doc : value.getDocumentChanges()){
                    ...
                    db.collection("user").document(doc.getDocument()
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            ...
                            Adapter = new delivered_order_adapter(view.getContext(), Phone_no,Profile , address , name, Total,UserId ,ProductCount,Time,Date , flag);
