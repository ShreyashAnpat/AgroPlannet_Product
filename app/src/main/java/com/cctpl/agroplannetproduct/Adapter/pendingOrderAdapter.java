...
public class pendingOrderAdapter extends RecyclerView.Adapter<pendingOrderAdapter.ViewHolder> {
    ...
    public pendingOrderAdapter(Context context, List<String> phone_no, List<String> profile, List<String> address, List<String> name, List<String> total, List<String> userId, List<String> productCount, List<String> time, List<String> date, List<String> flags) {
